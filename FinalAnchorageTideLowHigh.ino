...
void setup(void)
{
  Wire.begin();
  rtc.begin();
  //rtc.adjust(DateTime(2024, 5, 22, 9, 52, 0));
...
void hilow(){
  ...
  while(changer){
   ...
   //Serial.print("tideNow:");
   //Serial.println(tideNow);
   //Serial.print("tideFuture;");
   //Serial.println(tideFuture);
...
void boreTide(){
float tidalRange = highKeep - lowKeep;
Serial.print("range:");
